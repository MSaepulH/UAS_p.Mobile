...
import 'package:Warung_Madura/controllers/sales_controller.dart';
import 'package:Warung_Madura/models/sales_model.dart';
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              style: ButtonStyle(
                backgroundColor: WidgetStatePropertyAll(Color.fromARGB(255, 42, 250, 0)),
                foregroundColor: WidgetStatePropertyAll(Colors.black),
