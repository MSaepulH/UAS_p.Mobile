...
import 'package:Warung_Madura/models/stock_model.dart';
import 'package:Warung_Madura/controllers/stock_controller.dart';
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, value, child) {
        return Container(
          color: Color.fromARGB(255, 2, 250, 155),
          child: Center(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<Stock> filteredStocks = stocks
                      .where((stock) => stock.issuer == 'Muhamad Saepul Hidayat')
                      .toList();
